  ...
  <div class="app-shell">
    ...
    <main class="main-stage">
      ...
      <TerminalPanel
        ...
        :remote-ready="state.settings.connectionMode === 'ssh' && !!state.settings.sshTarget.trim()"
        :remote-target="state.settings.sshTarget"
        ...
        @open="session.openTerminal"
        @run="session.runTerminal"
        @write="session.writeTerminal"
        @binary="session.writeTerminalBinary"
